        ...
        <>
          ...
          <div className="sm:flex">
            ...
            <div className="flex-1 sm:mt-16">
              <div className="wfull sm:w-2/3 h-96 bg-blue-gray-100 ml-5 mt-5 rounded-lg">
                <div className="w-full h-32 bg-deep-orange-300 rounded-lg flex justify-center pt-14">
                  <div className="bg-deep-orange-800 border-2 w-80 h-32 rounded-lg grid grid-cols-[1fr,2fr]">
                    ...
                    <div className="mt-14 ml-8 text-white font-serif text-2xl">
                      {propertyData.user ? propertyData.user[0].first_name : ""}
                    </div>
                  </div>
                </div>
                <div>
                  <div className="flex ml-9 mt-28">
                    ...
                    <Typography className="ml-2">
                      Phone :{" "}
                      {propertyData.user ? propertyData.user[0].phone : ""}
                    </Typography>
                  </div>
                  <div className="flex ml-9 mt-5">
                    ...
                    <Typography className="ml-2">
                      Mail :{" "}
                      {propertyData.user ? propertyData.user[0].email : ""}
                    </Typography>
                  </div>
          ...
          <div className="ml-44 mt-8">{propertyData.description}</div>
          <div className="font-serif font-bold text-2xl ml-32 mt-20">
            More Details
          </div>
          ...
          <div className="ml-44 mt-8 flex">
            ...
            <div className="mt-2 ml-5">
              {propertyData.price_per_cent} Rs/cent
            </div>
          </div>
        </>
      ) : (
