...
import jwtDecode from "jwt-decode";
  ...
  export function PricingCard() {
    ...
    return (
      <Card color="brown" variant="gradient" className="w-full max-w-[20rem] p-8 ml-1">
        <CardHeader
          floated={false}
          shadow={false}
          color="transparent"
        ...
        >
          ...
          >
            <span className="mt-2 text-xl">₹</span>500{" "}
        ...
        <CardBody className="p-0">
          <ul className="flex flex-col gap-4">
            <li className="flex items-center gap-4">
              ...
              <Typography className="font-normal">3 Listing</Typography>
            </li>
            <li className="flex items-center gap-4">
              <span className="rounded-full border border-white/20 bg-white/20 p-1">
                <CheckIcon />
              </span>
              <Typography className="font-normal">1 Month Available</Typography>
            </li>
            <li className="flex items-center gap-4">
              <span className="rounded-full border border-white/20 bg-white/20 p-1">
                <CheckIcon />
              </span>
              <Typography className="font-normal" style={{textDecoration: 'line-through'}}>Non Featured</Typography>
            </li>
            <li className="flex items-center gap-4">
              <span className="rounded-full border border-white/20 bg-white/20 p-1">
                <CheckIcon />
              </span>
              <Typography className="font-normal" style={{textDecoration: 'line-through'}}>Limited Support</Typography>
            </li>
          </ul>
        </CardBody>
